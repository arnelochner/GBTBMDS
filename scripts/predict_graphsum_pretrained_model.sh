...
source ./model_config/graphsum_pretrained_model
...
python -u ./src/run.py \
               ...
               --decode_path ./results/multinews_downloaded_model \
               ...
               --log_file "log/graphsum_pretrained_predict.log" \
               --random_seed 1 > log/lanch_predict_pretrained.log 2>&1
